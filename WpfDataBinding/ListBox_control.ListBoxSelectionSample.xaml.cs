...
namespace WpfDataBinding
{
    public partial class ListBoxSelectionSample : Window
    {
        public ListBoxSelectionSample()
        {
            ...
            items.Add(new TodoItem() { Title = "Wash the car", Completion = 0 }); lbTodoList.ItemsSource = items;
        }
        ...
        {
            int nextIndex = 0; if ((lbTodoList.SelectedIndex >= 0)
                && (lbTodoList.SelectedIndex < (lbTodoList.Items.Count - 1)))
        ...
        private void btnSelectCSharp_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                if ((o is TodoItem)
                && ((o as TodoItem).Title.Contains("C#"))) 
        ...
        {
            foreach (object o in lbTodoList.Items) lbTodoList.SelectedItems.Add(o);
        }
    }
